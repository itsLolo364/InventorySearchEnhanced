...
public final class SearchHighlightPreviewProvider implements PreviewProvider {
    ...
    public SearchHighlightPreviewProvider(PreviewProvider delegate) {
        ...
        this.renderer = new SearchHighlightPreviewRenderer(delegate.getTheme());
    }
    ...
    public int getActiveSlotCount(PreviewContext context) {
        return this.delegate.getActiveSlotCount(context);
    }

    @Override
    public int getSelectedSlot(PreviewContext context) {
        return this.delegate.getSelectedSlot(context);
    }
