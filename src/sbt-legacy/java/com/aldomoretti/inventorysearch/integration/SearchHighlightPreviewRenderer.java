...
public final class SearchHighlightPreviewRenderer implements PreviewRenderer {
    ...
    private void drawSearchHighlights(GuiGraphics graphics, int x, int y) {
    ...
    private void drawSlotOverlay(GuiGraphics graphics, int x, int y, int slot, int maxRowSize) {
